...
global.owner = process.env.OWNER_NUMBER  || '27698908814' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "23_03_2024_SIGMA_MD_Qtmp8cqT_MAHER_ZUBAIR" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.mztit = process.env.MZTIT ||"coco-md",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '23_03_2024_SIGMA_MD_Qtmp8cqT_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'coco-md',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `mickyle`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'mickyle',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "mickyle" ,          // ADD YOUR STICKER PACKNAME
